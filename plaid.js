...
const CREDENTIALS = require('./plaid_credentials')

var APP_PORT = envvar.number('APP_PORT', 8000);
var PLAID_CLIENT_ID = envvar.string('PLAID_CLIENT_ID');
var PLAID_SECRET_DEVELOPMENT = envvar.string('PLAID_SECRET_DEVELOPMENT');
...
var PLAID_PRODUCTS = envvar.string('PLAID_PRODUCTS', 'balances');
